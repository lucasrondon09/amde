<main>
            ...
            <div class="container py-5">
                <div class="row d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-md-8 py-5 text-center text-md-start">
                        ...
                        <p class="pt-3">
                            Somos uma empresa especializada em soluções e serviços de tecnologia web. Oferecemos consultoria personalizada, desenvolvimento de aplicativos e sistemas sob demanda, além de criação de sites de alta performance.
                            Nossa equipe experiente busca soluções inovadoras, mapeando e estruturando sistemas para atender às necessidades de cada negócio. Estamos comprometidos em proporcionar excelência e sucesso digital aos nossos clientes.
                        ...
                        <ul class="list-inline">
                            ...
                            Saiba mais sobre a  <span class="fw-bolder">VMI Soluções Web</span>
    ...
    <div class="py-5 position-relative" style="background-color: #E3993B">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-3 my-3">
                    <div class="card w-100 border-0">
                        ...
                        <div class="card-body py-3">
                            ...
                            <a href="<?= base_url('Servicos/'.$servicoItem->slug);?>" class="btn btn-sm fw-bold px-3 btn-primary rounded-pill">Saiba mais
        ...
        <div class="container">
            <div class="row d-flex justify-content-center py-5">
                <div class="col-md-8 text-center">
                    ...
                    <p class="text-secondary">Cadastre seu e-mail e acompanhe as novidades da VMI Soluções Web.</p>
                    <div class="mt-4">
