  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?= $_ENV['ADMIN_LOGO']?>" alt="Start Site Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"><?= $_ENV['ADMIN_TITULO']?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= $_ENV['ADMIN_LOGO'];?>" class="w-100" alt="Logo">
        </div>
      </div>
      -->
